...
class OrderGroupCard extends StatelessWidget {
            ...
            children: [
                ...
                children: [
                  ...
                  if (status != null && status!.isNotEmpty)
                    Text(
                      status!,
                      style: TextStyle(
                        color: status == 'Cancelled' ? Colors.red : status == 'Pending' ? Colors.orange : Colors.lightBlue,
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
  decoration: BoxDecoration(
    gradient: AppColors.bgGradient, // ✅ gradient background
  ...
  child: ElevatedButton(
    ...
    child: Text(
      ...
      style: const TextStyle(
        color: AppColors.backgroundWhite, // white text
        fontSize: 12,
        fontWeight: FontWeight.w600,
      ),
    ),
